---
schema_version: 1
id: phase7-e2e-20260820102123-a2d280
title: Phase 7 Real GitHub review E2E 20260820102123-a2d280
status: PENDING
base_branch: e2e/phase7-20260820102123-a2d280
target_branch: agent/phase7-e2e-20260820102123-a2d280
allowed_paths:
  - app/e2e_phase7_20260820102123_a2d280.py
forbidden_paths:
  - .agent/state/**
  - .github/**
  - agent/**
...
Add one small, dependency-free Python utility at `app/e2e_phase7_20260820102123_a2d280.py`.

# Non-Goals

- Do not modify application infrastructure or orchestration.
- Do not modify any file except `app/e2e_phase7_20260820102123_a2d280.py`.
...
Create `app/e2e_phase7_20260820102123_a2d280.py` with a function:
...
```text
python -c "import runpy; f=runpy.run_path('app/e2e_phase7_20260820102123_a2d280.py')['normalize_csv']; assert f(' Alpha, beta, ALPHA, , Gamma ') == ('alpha', 'beta', 'gamma'); assert f('') == ()"
```
...
```text
python -c "import runpy; f=runpy.run_path('app/e2e_phase7_20260820102123_a2d280.py')['normalize_csv']; assert f('a,A,b,a') == ('a', 'b'); assert f(' , ') == (); assert f('x') == ('x',)"
```
