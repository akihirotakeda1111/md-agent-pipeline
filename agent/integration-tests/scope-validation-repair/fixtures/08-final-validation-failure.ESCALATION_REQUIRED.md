...
schema_version: 1
id: phase4-final
title: Phase 4 final validation failure
status: PENDING
base_branch: main
target_branch: test/phase4-final
allowed_paths: [app/**]
...
Exercise the real Phase 2 through Phase 4 pipeline for final validation failure.
...
Fixture marker `CASE_08_FINAL`. Make the smallest implementation change needed by this case.
