---
schema_version: 1
id: phase4-escalation
title: Phase 4 escalation required
status: PENDING
base_branch: main
target_branch: test/phase4-escalation
allowed_paths: [app/**]
...
Exercise the real Phase 2 through Phase 4 pipeline for escalation required.
...
Fixture marker `CASE_07_ESCALATION`. Make the smallest implementation change needed by this case.
