---
schema_version: 1
id: phase4-repair-scope
title: Phase 4 repair scope violation
status: PENDING
base_branch: main
target_branch: test/phase4-repair-scope
allowed_paths: [app/**]
...
Exercise the real Phase 2 through Phase 4 pipeline for repair scope violation.
...
Fixture marker `CASE_04_REPAIR_SCOPE`. Make the smallest implementation change needed by this case.
