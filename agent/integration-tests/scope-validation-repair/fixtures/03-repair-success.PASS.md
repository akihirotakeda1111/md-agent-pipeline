---
schema_version: 1
id: phase4-repair-success
title: Phase 4 repair success
status: PENDING
base_branch: main
target_branch: test/phase4-repair-success
allowed_paths: [app/**]
...
Exercise the real Phase 2 through Phase 4 pipeline for repair success.
...
Fixture marker `CASE_03_REPAIR_SUCCESS`. Make the smallest implementation change needed by this case.
