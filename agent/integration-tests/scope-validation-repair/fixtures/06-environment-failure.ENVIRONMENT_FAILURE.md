---
schema_version: 1
id: phase4-environment
title: Phase 4 environment failure
status: PENDING
base_branch: main
target_branch: test/phase4-environment
allowed_paths: [app/**]
...
Exercise the real Phase 2 through Phase 4 pipeline for environment failure.
...
Fixture marker `CASE_06_ENVIRONMENT`. Make the smallest implementation change needed by this case.
