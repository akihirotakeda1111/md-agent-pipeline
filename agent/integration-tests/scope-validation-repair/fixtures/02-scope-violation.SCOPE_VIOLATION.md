...
schema_version: 1
id: phase4-scope
title: Phase 4 scope violation
status: PENDING
base_branch: main
target_branch: test/phase4-scope
allowed_paths: [app/**]
...
Exercise the real Phase 2 through Phase 4 pipeline for scope violation.
...
Fixture marker `CASE_02_SCOPE`. Make the smallest implementation change needed by this case.
