---
schema_version: 1
id: phase7-e2e-20260820021317-2ee4bd
title: Phase 7 Real GitHub review E2E 20260820021317-2ee4bd
status: PENDING
base_branch: e2e/phase7-20260820021317-2ee4bd
target_branch: agent/phase7-e2e-20260820021317-2ee4bd
allowed_paths:
  - app/e2e_phase7_20260820021317_2ee4bd.py
forbidden_paths:
  - .agent/state/**
  - .github/**
  - agent/**
...
Add one small, dependency-free Python utility at `app/e2e_phase7_20260820021317_2ee4bd.py`.

# Non-Goals

- Do not modify application infrastructure or orchestration.
- Do not modify any file except `app/e2e_phase7_20260820021317_2ee4bd.py`.
...
Create `app/e2e_phase7_20260820021317_2ee4bd.py` with a function:
...
```text
python -c "import runpy; f=runpy.run_path('app/e2e_phase7_20260820021317_2ee4bd.py')['normalize_csv']; assert f(' Alpha, beta, ALPHA, , Gamma ') == ('alpha', 'beta', 'gamma'); assert f('') == ()"
```
...
```text
python -c "import runpy; f=runpy.run_path('app/e2e_phase7_20260820021317_2ee4bd.py')['normalize_csv']; assert f('a,A,b,a') == ('a', 'b'); assert f(' , ') == (); assert f('x') == ('x',)"
```
